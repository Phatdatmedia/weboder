...
form.addEventListener("submit", async (e) => {
  ...
  if (!roleRow) {
    ...
    window.location.href = "/showcase/qlbt/teacher/dashboard/";
  } else {
    window.location.href = "/showcase/qlbt/student/dashboard/";
  }
});
...
(async () => {
  ...
  if (session) {
    ...
    if (roleRow) {
      window.location.href = roleRow.role === "teacher" ? "/showcase/qlbt/teacher/dashboard/" : "/showcase/qlbt/student/dashboard/";
    }
  }
})();
