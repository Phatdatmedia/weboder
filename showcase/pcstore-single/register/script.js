...
document.getElementById("register-form").addEventListener("submit", async (e) => {
    ...
    try {
      ...
      errorBox.appendChild(el("div", { class: "form-error", style: "background:rgba(87,232,203,.1); border-color:var(--cyan); color:var(--cyan);" },
        "Đăng ký thành công! Vui lòng kiểm tra email để xác nhận, sau đó đăng nhập."));
      document.getElementById("register-form").reset();
    } catch (err) {
      errorBox.appendChild(el("div", { class: "form-error" }, err.message || "Đăng ký thất bại, vui lòng thử lại."));
    }
  });
