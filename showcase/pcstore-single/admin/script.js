...
async function init() {
    ...
    const revenue = orders.filter(o => o.payment_status === "paid" || o.status === "delivered")
    ...
    for (const s of stats) {
      statBox.appendChild(el("div", { class: "stat-card" }, [
        el("div", { class: "label" }, s.label),
        el("div", { class: "value mono" }, String(s.value)),
      ]));
    }
    ...
    for (const o of orders.slice(0, 10)) {
      tbody.appendChild(el("tr", {}, [
        ...
        el("td", {}, o.profiles?.full_name || "—"),
        el("td", {}, el("span", { class: `badge badge--${o.status}` }, STATUS_LABEL[o.status])),
