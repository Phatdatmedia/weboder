...
// ---- page logic ----
getCurrentUser().then((u) => { if (u) window.location.href = "/showcase/pcstore-single/"; });
  ...
  document.getElementById("login-form").addEventListener("submit", async (e) => {
    ...
    try {
      ...
      window.location.href = redirect || "/showcase/pcstore-single/";
    } catch (err) {
      errorBox.appendChild(el("div", { class: "form-error" }, "Email hoặc mật khẩu không đúng."));
    }
  });
